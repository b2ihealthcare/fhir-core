...
import com.b2international.fhir.r5.operations.*;
import com.fasterxml.jackson.databind.ObjectMapper;

/**
 * Verifies that {@link FhirR5JsonModule} correctly serializes and deserializes
 * FHIR R5 {@link BaseParameters} subclasses via a Jackson {@link ObjectMapper}.
 *
 * @since 0.5.0
 */
public class FhirR5JsonModuleParametersTest {
	...
	public void conceptMapTranslate_serialize() throws Exception {
		...
		assertThat(json).contains("\"name\":\"sourceCode\"");
		assertThat(json).contains("\"valueCode\":\"testSourceCode\"");
		assertThat(json).contains("\"name\":\"system\"");
