 ...
 * FHIR R4B {@code CodeSystem} resources via a Jackson {@link ObjectMapper}.
 *
 * @since 0.5.0
 */
public class FhirR4BJsonModuleCodeSystemTest {
	...
	private static CodeSystem buildCodeSystem() {
		...
		cs.setId("r4b-cs");
		cs.setUrl("http://example.com/r4b/cs");
		cs.setVersion("1.0.0");
		cs.setName("R4BExampleCS");
		cs.setTitle("R4B Example Code System");
	...
	private static void assertCodeSystem(final CodeSystem cs) {
		assertThat(cs.getId()).isEqualTo("r4b-cs");
		assertThat(cs.getUrl()).isEqualTo("http://example.com/r4b/cs");
		assertThat(cs.getVersion()).isEqualTo("1.0.0");
		assertThat(cs.getName()).isEqualTo("R4BExampleCS");
		assertThat(cs.getTitle()).isEqualTo("R4B Example Code System");
	...
	public void serialize_codeSystem() throws Exception {
		...
		assertThat(json).contains("\"url\":\"http://example.com/r4b/cs\"");
		assertThat(json).contains("\"version\":\"1.0.0\"");
		assertThat(json).contains("\"name\":\"R4BExampleCS\"");
	...
	public void deserialize_from_json_literal() throws Exception {
		final String json = """
		{
		  ...
		  "id": "r4b-cs",
		  "url": "http://example.com/r4b/cs",
		  "version": "1.0.0",
		  "name": "R4BExampleCS",
		  "title": "R4B Example Code System",
		  "status": "active",
		  "content": "complete",
		  "concept": [
		    {
