...
/**
 * Allows FHIR R4B Resources to be serialized directly into an existing
 * JsonGenerator (an abstraction provided by Jackson) without an intermediary buffer.
 *
 * @since 0.5.0
 */
final class R4BJsonCreatorAdapter implements org.hl7.fhir.r4b.formats.JsonCreator {

	private final JsonGenerator gen;

	R4BJsonCreatorAdapter(final JsonGenerator gen) {
		this.gen = gen;
	}
